...
Note the optional parameter `plotDownstreamProteinDomainsIfFusionIsOutOfFrame`. This let the user see protein domains encoded by the downstream gene even though the reading frame is not kept across the fusion junction.
